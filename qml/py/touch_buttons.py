...
class TouchButtons:
    ...
    def create_touch_buttons(self, button_width):
        ...
        self.left = pg.image.load("/usr/share/harbour-pygametest/qml/py/img/left.png").convert_alpha()
        self.left = pg.transform.scale(self.left, (button_width, button_width))

        self.right = pg.image.load("/usr/share/harbour-pygametest/qml/py/img/right.png").convert_alpha()
        self.right = pg.transform.scale(self.right, (button_width, button_width))

        self.power = pg.image.load("/usr/share/harbour-pygametest/qml/py/img/power.png").convert_alpha()
        self.power = pg.transform.scale(self.power, (button_width, button_width))

        self.shot = pg.image.load("/usr/share/harbour-pygametest/qml/py/img/shot.png").convert_alpha()
